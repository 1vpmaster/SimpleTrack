...
if __name__ == '__main__':
    data_root = '/dataset/Mix/MOT17/images/train'
    txt_path = '/dataset/Mix/MOT17/images/results/MOT17_half_ch_Decouple_byte_my'
    save_path = '/dataset/Mix/MOT17/images/results/MOT17_half_ch_Decouple_byte_my_dti'
