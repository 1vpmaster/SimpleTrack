...
class JDETracker(object):
    ...
    def update(self, im_blob, img0,seq_num, save_dir):
        ...
        dists = dists_giou.numpy()/2 + dists_embedding
        ...
        # dists_giou = matching.iou_distance(r_tracked_stracks, detections, 'giou')
        # dists = dists_giou.numpy()/2 + dists_embedding
        ...
        # dists_embedding = matching.embedding_distance(second_tracked_stracks, detections_second)
        # dists_giou = matching.iou_distance(second_tracked_stracks, detections_second,'giou')
        # dists = dists_embedding + dists_giou.numpy()/2
