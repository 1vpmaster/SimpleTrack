...
class Tracker(object):
    ...
    def step(self, results_with_low, public_det=None):
        ...
        box_giou = matching.iou_distance(det_boxes, track_boxes, 'giou')
        box_giou = box_giou.numpy()/2
        ...
        dist = np.maximum(0.0, cdist(dets.reshape(-1, 2), tracks.reshape(-1, 2), 'cosine'))
        ...
        if self.opt.hungarian:
            ...
            matched_indices, u_track, u_detection = matching.linear_assignment(dist, thresh=0.5)
        else:
